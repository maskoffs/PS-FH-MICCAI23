...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_decode=dict(_delete_=True,
                         type='AutoWeightedCELoss', class_weight=None, boundary_weight='neighbor', loss_weight=1.0)
    ),
    auxiliary_head=dict(
        num_classes=3,
        loss_decode=dict(_delete_=True,
                         type='AutoWeightedCELoss', class_weight=None, boundary_weight='neighbor', loss_weight=0.4)
    ),
)
