...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_decode=dict(_delete_=True,
            type='AutoWeightedCELoss', class_weight=None, boundary_weight='neighbor_s', loss_weight=1.0)
        ),
    auxiliary_head=dict(
        num_classes=3,
        loss_decode=dict(_delete_=True,
            type='AutoWeightedCELoss', class_weight=None, boundary_weight='neighbor_s', loss_weight=0.4)
    ),
)
...
load_from = 'work_dirs/upernet_r101_4xb4-AutoWeightedCE-80k_psfh-256x256/iter_80000.pth'